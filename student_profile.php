...
<body>
    <header>
        <nav class="navbar navbar-light">
            <div class="container">
                <a class="navbar-brand fw-bolder" href="student_profile.php">
                    <p>&nbsp; Profile</p>
                </a>
    ...
    <main class="container mx-auto border border-0 rounded rounded-2 p-5" style="width: 80%;">
        ...
        <?php
            ...
            {
                echo 
                "<strong>Id .  . . . . . . . . . . . . . . . . . .: </strong><span>", $row['id'],"</span><br>", 
                "<strong>Date of Birth. . . . . . . . .: </strong><span>",$row['birth_date'],"</span><br>","<strong>Phone Number .  . . . . : </strong><span>",$row['studentphone'],"</span><br>","<strong>Email . . . . . . . . . . . . . . . : </strong><span>",$row['studentemail'],"</span><br>",
                "<strong>Department  . . . . . . . . : </strong><span>",$row['dept'],"</span><br>",
                "<strong>Semester . . . . . . . . . . . : </strong><span>",$row['semester'],"</span><br>",
                "<strong>CGPA . . . . . . . . . . . . . . . : </strong><span>",$row['cgpa'],"</span><br>",
                "<strong>Blood Group  . . . . . . . . : </strong><span>",$row['blood_group'],"</span><br>","<strong>Address. . . . . . . . . . . . . : </strong><span>",$row['addr'],"</span><br>";
            }
            $con->close();
            ?>
    </main>
