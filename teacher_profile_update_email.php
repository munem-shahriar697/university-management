...
<body>
    <header>
        ...
        <nav class="navbar navbar-light">
            <div class="container justify-content-around">
                ...
                <a class="navbar-brand fw-bolder" href="teacher_profile_update_email.php">
                    <p>&nbsp; Email Update</p>
                </a>
    ...
    <main class="container mx-auto border border-0 rounded rounded-2 p-5" style="width: 80%;">
        ...
        <?php
            ...
            if(is_array($row))
            {
                echo "&nbsp; <strong>Current Email: </strong><span>",$row['teacheremail'],"</span><br>";
            }
        ?>
        <br><br>
        <div class="container">
                <div class="add">
                    <h3>Enter new phone to update</h3>
                        <form action="teacher_profile_update_email.php" method="post">
        ...
        <?php
            ...
            //echo $email;
            if($email!='' && $password!='' && $password==$row['teacherpass'])
            {
                $sql = "UPDATE teacher_user SET teacheremail = '$email' WHERE id = '$user';";
