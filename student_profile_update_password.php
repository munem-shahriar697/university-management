...
<body>
    ...
    <nav class="navbar navbar-light">
        ...
        <nav class="navbar navbar-light">
            ...
            <a class="navbar-brand" href="student_profile_update_phone.php">
                ...
                <a class="navbar-brand fw-bolder" href="student_profile_update_password.php">
                    <p>&nbsp; Password Update</p>
                </a>
            </div>
        </nav>
    ...
    <br><br>
        ...
        <?php
            ...
            if(is_array($row))
            {
                echo "&nbsp; <strong>Current Email: </strong><span>",$row['studentemail'],"</span><br>","&nbsp; <strong>Current Phone number: </strong><span>",$row['studentphone'],"</span>";
            }
        ?>
        <br><br>
        <div class="container">
                <div class="add">
                    <h3>Update your password</h3>
                        <form action="student_profile_update_password.php" method="post">
        ...
        <?php
            ...
            //echo $email;
            if($new_password1!='' && $new_password2!='' && $password!='' && $password==$row['studentpass'] && $new_password1==$new_password2)
            {
                $sql = "UPDATE student_user SET studentpass = '$new_password1' WHERE id = '$user';";
