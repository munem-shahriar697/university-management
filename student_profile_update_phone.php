...
<body>
    <header>
        ...
        <nav class="navbar navbar-light">
            <div class="container justify-content-around">
                <a class="navbar-brand fw-bolder" href="student_profile_update_phone.php">
    ...
    <main class="container mx-auto border border-0 rounded rounded-2 p-5" style="width: 80%;">
        ...
        <?php
            ...
            if(is_array($row))
            {
                echo "&nbsp; <strong>Current Phone number: </strong><span>",$row['studentphone'],"</span><br>";
            }
        ?>
        <br><br>
        <div class="container">
            <div class="add">
                ...
                <form action="student_profile_update_phone.php" method="post">
        ...
        <?php
            ...
            //echo $email;
            if($phone!='' && $password!='' && $password==$row['studentpass'])
            {
                $sql = "UPDATE student_user SET studentphone = '$phone' WHERE id = '$user';";
